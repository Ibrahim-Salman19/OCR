...
def start_server(host: str = "0.0.0.0", port: int = 8000, reload: bool = False, workers: int = 1):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--host", default="0.0.0.0", help="Binding IP address (default: 0.0.0.0)")
