...
graph TD
    ...
    C --> C1[All Community Features]
    C --> C2[Priority Queue Worker 4x]
    C --> C3[Searchable Sandwich PDF]
    C --> C4[Standard Support]
    
    D --> D1[All Pro Features]
    D --> D2[Unlimited Swarm Workers]
    D --> D3[Automated Zombie Reaper]
    D --> D4[S3/MinIO Tiered Streaming]
    D --> D5[Zero-Crash SLA & Direct Slack]
```
