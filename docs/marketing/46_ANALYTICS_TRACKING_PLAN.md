...
| `ocr_execution_completed`| Core Engine | Pipeline successfully exports results | `page_count` (int), `duration_sec` (float), `pages_per_sec` (float), `peak_ram_mb` (float) | `{page_count: 120, pages_per_sec: 0.065, peak_ram_mb: 142.1}` |
