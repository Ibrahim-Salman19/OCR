...
class TestGeminiSchemaCompliance:
    ...
    def test_success_result_has_required_top_level_keys(self, pipeline, test_image_path, tmp_output):
        """
        ...
        """
        with patch("blast_ocr.pipeline.process_page_wrapper", side_effect=mock_process_page):
    ...
    def test_output_files_has_md_and_docx_keys(self, pipeline, test_image_path, tmp_output):
        """
    ...
    def test_job_recorded_in_database_on_success(self, pipeline, test_image_path, tmp_output):
        """
...
class TestCleanup:
    ...
    def test_process_job_leaves_no_temp_png_files(self, pipeline, test_image_path, tmp_output):
        """
